...
- **Acción pendiente de Rubén (credencial local):** en `.env` → `DATABASE_URL="postgresql://postgres:ipd_dev_pw@localhost:5432/ipd?schema=public"`; en `.env.example`, la misma con la contraseña como `CHANGE_ME`.
